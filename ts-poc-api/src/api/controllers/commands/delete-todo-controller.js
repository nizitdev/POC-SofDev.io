...
let DeleteTodoController = class DeleteTodoController extends n_web_1.Controller {
    ...
    execute(model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._todoRepository.delete(model.id);
        });
    }
    validateModel(model) {
...
DeleteTodoController = __decorate([
    n_web_1.route(Routes.command.deleteTodo),
    n_web_1.command,
