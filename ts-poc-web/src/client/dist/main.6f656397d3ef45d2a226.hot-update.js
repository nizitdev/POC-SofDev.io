...
let ManageStudentMarkViewModel = class ManageStudentMarkViewModel extends n_app_1.PageViewModel {
    ...
    save() {
        ...
        savePromise
            .then(() => this._navigationService.navigate(Routes.listStudentMarks, {}))
